...
},{}],"../node_modules/odo-route/node_modules/path-to-regexp/index.js":[function(require,module,exports) {
...
},{"path-to-regexp":"../node_modules/odo-route/node_modules/path-to-regexp/index.js"}],"../../../.config/yarn/global/node_modules/process/browser.js":[function(require,module,exports) {
...
inject('pod', function (hub, exe) {
  exe.use('app code', function (params) {
    return new Promise(function (resolve, reject) {
      var socket = connection(params.host, params.token, {
        open: function open() {
          return socket.send('app_code', params.app);
        },
        app_code_complete: function app_code_complete(code) {
          socket.close();
          resolve(code);
        },
        socketError: function socketError(err) {
  ...
  hub.on('app publish', function (params) {
    return new Promise(function (resolve, reject) {
      var socket = connection(params.host, params.token, {
        open: function open() {
          return socket.send('app_publish', {
            app: params.app,
            code: params.code
          });
        },
        app_publish_complete: function app_publish_complete() {
          socket.close();
          resolve();
        },
        socketError: function socketError(err) {
