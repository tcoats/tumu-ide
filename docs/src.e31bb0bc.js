...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"index.styl":[function(require,module,exports) {

},{"./../fonts/FiraCode-Light.eot":[["FiraCode-Light.398b50e9.eot","../fonts/FiraCode-Light.eot"],"../fonts/FiraCode-Light.eot"],"./../fonts/FiraCode-Light.woff2":[["FiraCode-Light.a0e6b093.woff2","../fonts/FiraCode-Light.woff2"],"../fonts/FiraCode-Light.woff2"],"./../fonts/FiraCode-Light.woff":[["FiraCode-Light.b2af08a1.woff","../fonts/FiraCode-Light.woff"],"../fonts/FiraCode-Light.woff"],"./../fonts/FiraCode-Light.ttf":[["FiraCode-Light.75b09da1.ttf","../fonts/FiraCode-Light.ttf"],"../fonts/FiraCode-Light.ttf"]}],"../node_modules/snabbdom/vnode.js":[function(require,module,exports) {
"use strict";
...
},{"./vnode":"../node_modules/snabbdom/vnode.js","./is":"../node_modules/snabbdom/is.js"}],"../node_modules/odoql2/node_modules/fast-deep-equal/index.js":[function(require,module,exports) {
'use strict';
...
},{"fast-deep-equal":"../node_modules/odoql2/node_modules/fast-deep-equal/index.js"}],"../node_modules/injectinto/inject.js":[function(require,module,exports) {
const inject = () => {
  let bindings = {}
  return {
    bind: (key, item) => {
...
},{"path-to-regexp":"../node_modules/path-to-regexp/index.js"}],"../../../.config/yarn/global/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../.config/yarn/global/node_modules/process/browser.js"}],"hosts.js":[function(require,module,exports) {
...
inject('pod', function (hub, exe) {
  exe.use('hosts', function () {
    return Promise.resolve(get('hosts', {}));
  });
  hub.on('add host', function (host) {
    var hosts = get('hosts', {});
    hosts[host.host] = host;
    set('hosts', hosts);
  });
  hub.on('remove host', function (host) {
    var hosts = get('hosts', {});
    delete hosts[host];
    set('hosts', hosts);
  });
...
var socketError = function socketError(err) {
  if (err.code == 'ECONNREFUSED') console.error("Connection to tumu host refused");
  console.error(err);
};

module.exports = function (host, token, callbacks) {
  if (!callbacks.socketError) callbacks.socketError = socketError;
  var fin = false;
  var socket = new WebSocket(host, token);
  ...
  socket.onmessage = function (e) {
    ...
    if (callbacks[payload[0]]) callbacks[payload[0]](payload[1]);else if (payload[0] == 'error') {
      socket.close();
      callbacks.socketError(payload[1]);
    } else callbacks.socketError("callback not found ".concat(payload[0]));
  };

  if (callbacks.close) socket.onclose = callbacks.close;
  return {
    send: function send(command, params) {
...
inject('pod', function (hub, exe) {
  exe.use('status', function (params) {
...
inject('page:workspaces', ql.component({
  ...
  render: function render(state, params, hub) {
    if (!state.status) return inject('page:error')(state, {
...
inject('page:apps', ql.component({
  ...
  render: function render(state, params, hub) {
    ...
    if (!workspace) return inject('page:error')(state, {
...
inject('pod', function (hub, exe) {});
route('/host/:host/workspace/:workspace/app/:app/', function (p) {
  return {
    page: 'editor',
    host: p.params.host,
    workspace: p.params.workspace,
...
},{"snabbdom/h":"../node_modules/snabbdom/h.js","odoql2":"../node_modules/odoql2/index.js","injectinto":"../node_modules/injectinto/inject.js","odo-route":"../node_modules/odo-route/index.js","codemirror":"../node_modules/codemirror/lib/codemirror.js","codemirror/mode/javascript/javascript":"../node_modules/codemirror/mode/javascript/javascript.js","./connection":"connection.js"}],"../node_modules/qrcode/lib/can-promise.js":[function(require,module,exports) {
...
},{"./can-promise":"../node_modules/qrcode/lib/can-promise.js","./core/qrcode":"../node_modules/qrcode/lib/core/qrcode.js","./renderer/canvas":"../node_modules/qrcode/lib/renderer/canvas.js","./renderer/svg-tag.js":"../node_modules/qrcode/lib/renderer/svg-tag.js"}],"fixhosturl.js":[function(require,module,exports) {
module.exports = function (host) {
  if (!host) return host;
  if (host.indexOf('ws://') == -1) return "ws://".concat(host);
  return host;
};
...
var fixHostUrl = require('./fixhosturl');

inject('pod', function (hub, exe) {
  hub.on('login', function (params) {
    var host = fixHostUrl(params.host);
    var socket = connection(host, null, {
      open: function open() {
        return socket.send('login', params.emailAddress);
      },
      login_complete: function login_complete(token) {
        socket.close();
        hub.emit('add host', {
          host: host,
          ...
          return page("../".concat(encodeURIComponent(host), "/"));
        });
      },
      login_secret_generated: function login_secret_generated(secret) {
        socket.close();
        qrcode.toDataURL("otpauth://totp/SecretKey?secret=".concat(secret)).then(function (secretSrc) {
      ...
      login_challenge: function login_challenge() {
        socket.close();
        hub.emit('update', {
          challenge: true
        });
  ...
  hub.on('login code', function (params) {
    var host = fixHostUrl(params.host);
    var socket = connection(host, null, {
      open: function open() {
        return socket.send('login_code', {
          emailAddress: params.emailAddress,
          code: params.code
        });
      },
...
inject('page:login', ql.component({
  ...
  render: function render(state, params, hub) {
    ...
    if (params.challenge) {
      var updateCode = function updateCode(e) {
        hub.emit('update', {
          code: e.target.value
        });
      };
      ...
      }, _toConsumableArray(params.secret ? [h('label', 'Authenticator secret'), h('img.secret', {
        attrs: {
          src: params.secretSrc
        }
      }), h('div.secret', params.secret)] : []).concat([h('label', 'Authenticator code'), h('input', {
        on: {
          keyup: updateCode
        },
        attrs: {
    ...
    var updateEmailAddress = function updateEmailAddress(e) {
      hub.emit('update', {
    ...
    }), h('label', 'Email address'), h('input', {
      on: {
        keyup: updateEmailAddress
      },
      attrs: {
        type: 'text',
...
},{"snabbdom/h":"../node_modules/snabbdom/h.js","odoql2":"../node_modules/odoql2/index.js","injectinto":"../node_modules/injectinto/inject.js","odo-route":"../node_modules/odo-route/index.js","qrcode":"../node_modules/qrcode/lib/browser.js","./connection":"connection.js","./fixhosturl":"fixhosturl.js"}],"error.js":[function(require,module,exports) {
var h = require('snabbdom/h').default;
...
},{"fast-deep-equal":"../node_modules/odoql2/node_modules/fast-deep-equal/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
